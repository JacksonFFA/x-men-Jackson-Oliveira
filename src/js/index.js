...
na lista temos que adicionar a borda azul de seleção na imagem pequena do personagem e mostrar 
a imagem, o nome e o texto grande do personagem que está selecionado

    OBJETIVO 1 - quando passar o mouse em cima do personagem que está na listageml, devemos
    selecioná-lo
...
// na listagem, devemos selecioná-los

// passo 1 - pegar os personagens no JS pra verificar quando o usuário
...
// passo 2 - adicionar a classe selecionada no paersonagem usuário passar o cursor do mause
...
personagens.forEach((personagem) => {
   personagem.addEventListener("mouseenter",() => {
    if(window.innerWidth < 450) {
     ...
     //passo 1 -  pegar o elemento do personagem grande pra adicionar as informaões nele
     alterarImagemPerosnagemSelecionado(personagem);
...
function alterarImagemPerosnagemSelecionado(personagem) {
